...
using Hatles.Adminify.Identity;
...
namespace Hatles.Adminify.Web.Host.Startup
{
    public class Startup
    {
        ...
        public void Configure(IApplicationBuilder app,  ILoggerFactory loggerFactory)
        {
            ...
            {
                options.SwaggerEndpoint(_appConfiguration["App:ServerRootAddress"].EnsureEndsWith('/') + "swagger/v1/swagger.json", "Adminify API V1");
                options.IndexStream = () => Assembly.GetExecutingAssembly()
                    .GetManifestResourceStream("Hatles.Adminify.Web.Host.wwwroot.swagger.ui.index.html");
            }); // URL: /swagger
        }
    }
}
